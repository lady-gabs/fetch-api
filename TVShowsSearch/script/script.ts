...
async function tvShowData() {
    ...
    for (let i = 0; i < data.length ; i++) {
        if (data[i].show.image === null) {
            result.innerHTML += `
            <li>
                <svg width="200px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 115.19 123.38" style="enable-background:new 0 0 115.19 123.38" xml:space="preserve">
                    <style type="text/css">
